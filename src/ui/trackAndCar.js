...
export function createTrackAndCar(data, idx){
  // const [data, idx] = args
	console.log(data[idx])

	let trackSection = document.createElement('section')
				...
				<div class="track-container">
					...
					<div class="track">
						...
						<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
							...
							fill="${data[idx].color}" stroke="none">
...
trackSection.insertAdjacentHTML('afterbegin', trackSectionContent);
return trackSection
